...
async function carregarImovel() {
  // No app Next o imóvel já vem renderizado no servidor (page.tsx faz a
  // busca no Sanity) e é injetado como window.__TAMADA_PROPERTY__ antes
  // deste script carregar — nada de fetch aqui.
  return window.__TAMADA_PROPERTY__ || null;
}
