...
const SAIDA = path.resolve('..', 'redesign-atlas-urbano', 'catalog-data.js')
...
/* Registro completo de cada imóvel, um arquivo por imóvel.
   ...
   abertura. */
const PASTA_DADOS = path.resolve('..', 'redesign-atlas-urbano', 'imovel')
...
if (DRY) {
  ...
  fs.rmSync(path.resolve('..', 'redesign-atlas-urbano', 'fotos'), {recursive: true, force: true})
